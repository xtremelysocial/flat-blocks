...
function flat_blocks_condition_to_render_social_menu( $block_content, $block ) {
...
function flat_blocks_theme_has_navigation_social_links_settings( $theme_data ) {
	return $theme_data
...
function flat_blocks_social_menu_render( $block_content, $block ) {
	if ( flat_blocks_condition_to_render_social_menu( $block_content, $block ) ) {
 ...
 */
add_filter( 'render_block', 'flat_blocks_social_menu_render', 10, 2 );
