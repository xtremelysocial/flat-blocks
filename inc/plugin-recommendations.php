...
// 			'is_callable'        => '',
		...
		// XS Animation Plugin (from github)
		array(
		...
		// XS Dashicons Plugin (from github)
		array(
			'name'      	=> 'Dashicons Icon by XtremelySocial',
			'slug'      	=> 'xs-dashicons',
// 			'source'    	=> 'https://github.com/xtremelysocial/xs-dashicons',
			'source'		=> 'https://github.com/xtremelysocial/xs-dashicons/archive/refs/heads/main.zip',
			'required' 		=> false,
		),

		// TESTING: Test plugin on github
		array(
			'name'      	=> 'Test plugin on github',
			'slug'      	=> 'extend-block-example-wp-plugin',
			'source'		=> 'https://github.com/timnicholson/extend-block-example-wp-plugin/archive/refs/heads/master.zip',
			'external_url'	=> 'https://github.com/timnicholson/extend-block-example-wp-plugin/',
			'required' 		=> false,
// 			'version'		=> 1.1,
		),

		// Jetpack Plugin (from WordPress.org)
		// For widget visibility, better looking image galleries, etc.
		array(
